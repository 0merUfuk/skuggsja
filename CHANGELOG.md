...
- Default before/after SHA-256 audit with recursive source-root and source-containing-directory membership comparison.
...
- Generation and cleanup reject shared, nested, aliased, or case-equivalent source/output locations, including paths returned with discovery errors.
