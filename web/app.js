...
(function () {
  ...
  const solidGlyphs = { claude: true, codex: true };
  // Harness marks. Claude and Codex carry their published monochrome marks as
  // path data; Hermes and Cursor are drawn from the geometry the design assets
  // give them (a notched triangle, a three-face cube). Every shape stays a
  // local primitive: nothing here loads an asset or a brand file at run time.
  ...
  const glyphShapes = {
    ...
    hermes: [
      ["path", { d: "M12 3.3 21.4 20.5h-6.9L12 22.6l-2.5-2.1H2.6Z" }],
      ["path", { d: "M12 11.7 16.3 19h-8.6Z", class: "glyph-face" }]
    ],
    cursor: [
      ["path", { d: "M12 12 20.4 7.2v9.6L12 21.6Z", class: "glyph-face" }],
      ["path", { d: "M12 2.4 20.4 7.2v9.6L12 21.6 3.6 16.8V7.2Z" }],
      ["path", { d: "M3.6 7.2 12 12l8.4-4.8M12 12v9.6" }]
    ],
    unknown: [
